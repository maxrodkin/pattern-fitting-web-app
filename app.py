...
if uploaded_file:
    ...
    st.dataframe(df)
    packer, rectangles, bins, all_rects, unfitted_rects = mpr.pack_patterns(pattern_list, fabric_width, fabric_height)
    fig =mpr.visualize_packing(packer, fabric_width, fabric_height, unfitted_rects=unfitted_rects)
    st.pyplot(fig)
